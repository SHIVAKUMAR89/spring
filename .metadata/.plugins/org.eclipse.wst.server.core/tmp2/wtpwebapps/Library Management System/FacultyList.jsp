...
<table border=1>
<tr>
<th>User Name</th><th>Password</th><th>Lib Id</th><th>Name</th><th>Designation</th><th>Branch</th><th>Contact No.</th><th>No. of Lectures</th>

</tr>

<%
	ArrayList<FacultyInfo> al=(ArrayList)request.getAttribute("teachers");

	Iterator<FacultyInfo> it=al.iterator();
	while(it.hasNext()){		
		FacultyInfo d= (FacultyInfo)it.next();
%>
