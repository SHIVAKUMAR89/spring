...
public class ReserveBookServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		BookIssuedInfo bi= new BookIssuedInfo();
		...
		if(userId!=0) {
			...
			bi.setUserId(userId1);
		}
		
		bi.setIssueDate(new Date());
		bi.setReturnDate(new Date());
		bi.setReserveStatus(true);
		
		BookIssuedDAO.insertData(bi, con);
