...
/**
 * Servlet implementation class DisplayReservedBooks
 */
@WebServlet("/DisplayReservedBooks")
public class DisplayReservedBooks extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DisplayReservedBooks() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ArrayList<BookIssuedInfo> al= BookIssuedDAO.displayReserved(con);
